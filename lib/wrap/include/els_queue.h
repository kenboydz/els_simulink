...
void els_queue_init(ElsQueue * const self,
					const ElsQueueInitParam * const param);

bool els_queue_push(ElsQueue * const self, const void * const data);

bool els_queue_push_to_front(ElsQueue * const self, const void * const data);

bool els_queue_pull(ElsQueue * const self, void * const data);

void els_queue_drop(ElsQueue * const self);

// 作为 mailbox 使用，修改 mailbox 值，只修改 top 值
bool els_queue_overwrite(ElsQueue * const self, const void * const data);

// 作为 mailbox 使用，读取 mailbox 值，只读取 top 值
bool els_queue_peek(ElsQueue * const self, void * const data);

void els_queue_reset(ElsQueue * const self);
