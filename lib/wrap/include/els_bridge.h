...
void els_bridge_init(const ElsBridgeInitParam * param);
...
els_bridge_enable_send_filter(const uint_least8_t rec_id) {
    bridge._send_filter_mask |= (1U << rec_id);
}
...
void _els_bridge_begin_rec(uint_least8_t rec_id);
...
void _els_bridge_uint8(ElsBridgeType fmt, uint_least8_t data);
void _els_bridge_uint16(ElsBridgeType fmt, uint16_t data);
void _els_bridge_uint32(ElsBridgeType fmt, uint32_t data);
void _els_bridge_float(ElsBridgeType fmt, float data);
void _els_bridge_str(const char * data);
