...
#define LIMIT_RANGE(a, max, min)    do { \
    if ((a) > (max)) { \
        (a) = (max); \
    } else if ((a) < (min)) { \
        (a) = (min); \
...
//---------------------------------------------------------------------------
float __PC_IQtoF(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_FtoIQ(float a, int_least8_t frac);
...
//---------------------------------------------------------------------------
#define   _IQNtoM(A, N, M)      M > (N) ? \
                                ( (A) << ( (M) - (N) ) ) : \
                                ( (A) >> ( (N) - (M) ) )
//---------------------------------------------------------------------------
#define   _IQmpy2(A)        ((A)<<1U)
#define   _IQmpy4(A)        ((A)<<2U)
#define   _IQmpy8(A)        ((A)<<3U)
#define   _IQmpy16(A)       ((A)<<4U)
#define   _IQmpy32(A)       ((A)<<5U)
#define   _IQmpy64(A)       ((A)<<6U)

#define   _IQdiv2(A)        ((A)>>1U)
#define   _IQdiv4(A)        ((A)>>2U)
#define   _IQdiv8(A)        ((A)>>3U)
#define   _IQdiv16(A)       ((A)>>4U)
#define   _IQdiv32(A)       ((A)>>5U)
#define   _IQdiv64(A)       ((A)>>6U)
//---------------------------------------------------------------------------
int32_t __PC_IQmpy(int32_t a, int32_t b, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t  __PC_IQrmpy(int32_t a, int32_t b, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQrsmpy(int32_t a, int32_t b, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQdiv(int32_t a, int32_t b, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQsin(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQsinPU(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQasin(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQcos(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQcosPU(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQacos(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQatan2(int32_t a, int32_t b, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQatan2PU(int32_t a, int32_t b, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQsqrt(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQisqrt(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQexp(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQint(int32_t a, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQfrac(int32_t a, int_least8_t frac);
...
int32_t __PC_IQmpyIQX(int32_t a, int32_t b, int_least8_t frac);
...
*/
//---------------------------------------------------------------------------
int32_t __PC_IQmag(int32_t a, int32_t b, int_least8_t frac);
...
//---------------------------------------------------------------------------
int32_t __PC_IQlog(int32_t a, int_least8_t frac);
